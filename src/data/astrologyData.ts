...
export interface Prediction {
  ...
  isPositive: boolean
  triggerRasi?: string[]
  triggerNatchatiramPlanet?: Planet[]
  triggerSaniType?: string[]
}
...
export const PREDICTION_POOL: Prediction[] = [
  ...
  // ── SANI-PHASE POSITIVE ──────────────────────────────────
  { id: 'ps01', icon: '🔱', headline: "Saturn's Final Test — Breakthrough Imminent", elaboration: "You are nearing the end of Sade Sati's rising phase. The hardships of recent years are crystallising into hard-won wisdom and unshakeable inner strength. A major breakthrough in career or personal identity is close — hold your course with discipline.", category: 'spiritual', triggerPlanets: ['Saturn', 'Jupiter'], triggerMoolankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], triggerBhagyankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], isPositive: true, triggerSaniType: ['sade_sati_rising'] },
  { id: 'ps02', icon: '⚡', headline: "Sade Sati Peak — Your Deepest Transformation", elaboration: "Saturn sits directly on your Moon sign, testing every foundation you have built. This is the most spiritually significant period of your 30-year Saturn cycle. Those who persevere with discipline, humility, and regular Shani remedies emerge as entirely transformed, elevated beings.", category: 'spiritual', triggerPlanets: ['Saturn', 'Ketu'], triggerMoolankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], triggerBhagyankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], isPositive: true, triggerSaniType: ['sade_sati_peak'] },
  { id: 'ps03', icon: '🌤️', headline: "Sade Sati Lifts — The Dawn After the Storm", elaboration: "Saturn's 7.5-year trial is entering its final phase. The worst pressures are behind you. Suppressed career growth, stalled relationships, and delayed financial goals all begin to unblock and resume their upward trajectory within the next 12–18 months.", category: 'career', triggerPlanets: ['Saturn', 'Jupiter', 'Sun'], triggerMoolankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], triggerBhagyankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], isPositive: true, triggerSaniType: ['sade_sati_setting'] },
  { id: 'ps04', icon: '🌟', headline: "Saturn's Clear Sky — Your Power Years Begin", elaboration: "You are in Saturn's most favourable cycle — free from Sade Sati and Ashtama pressures. This is the window your elders would call 'Shani grace' — career growth, financial accumulation, and relationship stability all accelerate. Bold decisions made now carry long-lasting positive rewards.", category: 'finance', triggerPlanets: ['Jupiter', 'Venus', 'Sun'], triggerMoolankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], triggerBhagyankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], isPositive: true, triggerSaniType: ['clear'] },
  { id: 'ps05', icon: '🪬', headline: "Ashtama Sani — Hidden Strength Surfaces", elaboration: "Saturn in the 8th house from your Rasi is a period of intense inner transformation. While external conditions feel restrictive, extraordinary hidden strength, occult wisdom, and karmic acceleration are activating beneath the surface. Those who look inward now receive profound spiritual gifts.", category: 'spiritual', triggerPlanets: ['Saturn', 'Ketu', 'Jupiter'], triggerMoolankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], triggerBhagyankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], isPositive: true, triggerSaniType: ['ashtama_sani'] },

  // ── RASI ELEMENT POSITIVE ────────────────────────────────
  { id: 'pr01', icon: '🔥', headline: "Fire Sign Momentum — Your Natural Dominance Returns", elaboration: "Your fire Rasi nature is igniting. Mars and Sun energy aligns with your birth sign to create a period of exceptional confidence, boldness, and natural authority. Take the lead on projects and relationships — others will naturally follow your energy during this activated window.", category: 'career', triggerPlanets: ['Sun', 'Mars', 'Jupiter'], triggerMoolankRange: [1, 9, 3], triggerBhagyankRange: [1, 9, 3], isPositive: true, triggerRasi: ['Mesham', 'Simmam', 'Dhanusu'] },
  { id: 'pr02', icon: '🌿', headline: "Earth Sign Stability — Prosperity Takes Root", elaboration: "Your earth Rasi provides exceptional staying power during this period. While others chase volatile opportunities, your grounded nature attracts sustainable wealth, reliable partnerships, and long-term property gains. The seeds of material security you plant now will bear fruit for decades.", category: 'finance', triggerPlanets: ['Venus', 'Mercury', 'Saturn'], triggerMoolankRange: [6, 5, 8], triggerBhagyankRange: [6, 5, 8], isPositive: true, triggerRasi: ['Rishabam', 'Kanni', 'Makaram'] },
  { id: 'pr03', icon: '🌬️', headline: "Air Sign Intelligence — Communication Opens Doors", elaboration: "Your air Rasi intellect is at its sharpest. Mercury and Rahu amplify your natural communication gifts — expect a period where your words, ideas, and networks create opportunities that raw effort alone could never generate. A speech, writing project, or negotiation becomes a turning point.", category: 'business', triggerPlanets: ['Mercury', 'Rahu', 'Jupiter'], triggerMoolankRange: [5, 3, 4], triggerBhagyankRange: [5, 3, 4], isPositive: true, triggerRasi: ['Midhunam', 'Thulam', 'Kumbam'] },
  { id: 'pr04', icon: '🌊', headline: "Water Sign Intuition — Emotional Mastery Peaks", elaboration: "Your water Rasi deepens its natural empathy and psychic sensitivity this period. The Moon's influence on your sign brings exceptional intuition about people, timing, and decisions. Trust your gut feelings completely — they are accessing cosmic information your rational mind cannot see.", category: 'spiritual', triggerPlanets: ['Moon', 'Jupiter', 'Ketu'], triggerMoolankRange: [2, 3, 7], triggerBhagyankRange: [2, 3, 7], isPositive: true, triggerRasi: ['Kadagam', 'Vrichigam', 'Meenam'] },

  // ── NATCHATIRAM PLANET POSITIVE ──────────────────────────
  { id: 'pn01', icon: '☀️', headline: "Solar Birth Star Activates — Authority & Vitality Peak", elaboration: "Your birth star is ruled by the Sun, and a solar activation period is now in effect. Leadership opportunities, government recognition, and health improvements all converge. This is your time to step fully into the authority and visibility your soul came to express.", category: 'recognition', triggerPlanets: ['Sun', 'Mars'], triggerMoolankRange: [1, 9], triggerBhagyankRange: [1, 9], isPositive: true, triggerNatchatiramPlanet: ['Sun'] },
  { id: 'pn02', icon: '🪐', headline: "Saturn Birth Star — Karmic Rewards Delivered", elaboration: "Your Pushya, Anuradha, or Uttara Bhadrapada birth star carries Saturn's deep karmic precision. A period of remarkable karmic reward is activating — past-life merits and this-life disciplined efforts are now being tallied and delivered as tangible blessings in career, property, and family.", category: 'property', triggerPlanets: ['Saturn', 'Jupiter'], triggerMoolankRange: [8, 3], triggerBhagyankRange: [8, 3], isPositive: true, triggerNatchatiramPlanet: ['Saturn'] },
  { id: 'pn03', icon: '♂️', headline: "Mars Birth Star — Courage Rewarded, Obstacles Cleared", elaboration: "Your Mrigasira, Chitra, or Dhanishta birth star carries Mars energy. A period of exceptional physical courage and decisive action is activated — obstacles that seemed immovable are suddenly clearable with bold, direct action. A victory in competition, conflict, or entrepreneurship is strongly indicated.", category: 'career', triggerPlanets: ['Mars', 'Sun'], triggerMoolankRange: [9, 1], triggerBhagyankRange: [9, 1], isPositive: true, triggerNatchatiramPlanet: ['Mars'] },

  // ── SANI-PHASE WARNINGS ──────────────────────────────────
  { id: 'ws01', icon: '⚠️', headline: "Sade Sati Rising — Prepare Your Foundations", elaboration: "Saturn is entering the first house before your birth sign — a classic early warning of Sade Sati beginning. Financial pressure, travel disruptions, and sleep disturbances are common. Begin Shani Pariharam immediately: Sesame oil lamp on Saturdays, Shani Stotram recitation, charitable giving to the poor.", category: 'finance', triggerPlanets: ['Saturn', 'Rahu'], triggerMoolankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], triggerBhagyankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], isPositive: false, triggerSaniType: ['sade_sati_rising'] },
  { id: 'ws02', icon: '🌑', headline: "Sade Sati Peak — Guard Health & Career Carefully", elaboration: "Janma Sani is directly over your Moon sign. Career stagnation, health challenges, and relationship tests are intensified. Do not make major financial commitments or sign binding contracts during this phase without thorough due diligence. Regular Shani temple visits and Neelambari Shani puja provide strong protection.", category: 'health', triggerPlanets: ['Saturn', 'Rahu', 'Ketu'], triggerMoolankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], triggerBhagyankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], isPositive: false, triggerSaniType: ['sade_sati_peak'] },
  { id: 'ws03', icon: '💸', headline: "Sade Sati Setting — Protect Finances & Family", elaboration: "As Sade Sati moves to its setting phase in the 2nd house from your Rasi, financial speech and family communication come under pressure. Guard against hasty spending, signing guarantees for others, or harsh words in family settings. The end is near — patience and financial discipline are critical now.", category: 'family', triggerPlanets: ['Saturn', 'Mercury'], triggerMoolankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], triggerBhagyankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], isPositive: false, triggerSaniType: ['sade_sati_setting'] },
  { id: 'ws04', icon: '🕳️', headline: "Ashtama Sani — Hidden Obstacles Require Vigilance", elaboration: "Saturn transiting the 8th house from your Rasi activates a hidden obstacles cycle. Legal, financial, and health issues may emerge from unexpected directions. Avoid risky ventures, legal shortcuts, and ego confrontations. Consistent Shani and Ketu remedies provide a protective buffer through this transit.", category: 'health', triggerPlanets: ['Saturn', 'Ketu', 'Rahu'], triggerMoolankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], triggerBhagyankRange: [1, 2, 3, 4, 5, 6, 7, 8, 9], isPositive: false, triggerSaniType: ['ashtama_sani'] },

  // ── RASI ELEMENT WARNINGS ────────────────────────────────
  { id: 'wr01', icon: '🔥', headline: "Fire Sign Impulsiveness — Slow Down Before Acting", elaboration: "Your fire Rasi nature may drive you toward hasty decisions this period. Mars overstimulation creates overconfidence, anger flare-ups, and costly impulsive choices in career and relationships. Channel this intense energy into structured plans — success comes from focused fire, not wildfire.", category: 'career', triggerPlanets: ['Mars', 'Rahu', 'Sun'], triggerMoolankRange: [9, 1, 4], triggerBhagyankRange: [9, 1, 4], isPositive: false, triggerRasi: ['Mesham', 'Simmam', 'Dhanusu'] },
  { id: 'wr02', icon: '🌿', headline: "Earth Sign Stubbornness — Resist Change at Your Peril", elaboration: "Your earth Rasi's stability can become rigidity during this transit. Resistance to necessary change — in career, relationships, or financial strategy — creates costly stagnation. The opportunities being presented require flexibility and a willingness to release what has become comfortable but limiting.", category: 'business', triggerPlanets: ['Saturn', 'Ketu', 'Rahu'], triggerMoolankRange: [8, 7, 4], triggerBhagyankRange: [8, 7, 4], isPositive: false, triggerRasi: ['Rishabam', 'Kanni', 'Makaram'] },
  { id: 'wr03', icon: '🌬️', headline: "Air Sign Scattered Energy — Focus or Lose Ground", elaboration: "Your air Rasi intellectual restlessness is amplified, creating scattered attention across too many projects and relationships simultaneously. Mercury overload leads to communication errors, broken commitments, and missed opportunities. Choose your top three priorities ruthlessly and guard them.", category: 'business', triggerPlanets: ['Mercury', 'Rahu', 'Saturn'], triggerMoolankRange: [5, 4, 8], triggerBhagyankRange: [5, 4, 8], isPositive: false, triggerRasi: ['Midhunam', 'Thulam', 'Kumbam'] },
  { id: 'wr04', icon: '🌊', headline: "Water Sign Emotional Flooding — Boundaries Required", elaboration: "Your water Rasi's depth becomes overwhelming during this period — emotional overwhelm, psychic absorption of others' negative energies, and unhealthy attachment patterns surface. Establish clear emotional boundaries, reduce time with energy-draining individuals, and prioritise grounding spiritual practice.", category: 'health', triggerPlanets: ['Moon', 'Ketu', 'Saturn'], triggerMoolankRange: [2, 7, 8], triggerBhagyankRange: [2, 7, 8], isPositive: false, triggerRasi: ['Kadagam', 'Vrichigam', 'Meenam'] },
]
